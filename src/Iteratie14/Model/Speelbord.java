...
public class Speelbord {
    public static final int AANTAL_RIJEN = 21;
    public static final int AANTAL_KOLOMMEN = 21;
    private final List<Vak> vakken=new ArrayList<>();
...
// landingsbanen
        for (int j = 18; j > 10; j--, z++) {
            vakken.add(new LandingsBaan(Kleur.ROOD, z, j, 10));
        }// 69 - tem 76
        for (int l = 2; l < 10; l++, z++) {
            vakken.add(new LandingsBaan(Kleur.BLAUW, z, 10, l));
        }// 77 - tem 84
        for (int m = 2; m < 10; m++, z++) {
            vakken.add(new LandingsBaan(Kleur.GEEL, z, m, 10));
        }  // 85 - tem 92
        for (int k = 18; k > 10; k--, z++) {
            vakken.add(new LandingsBaan(Kleur.GROEN, z, 10, k));
        }  //  93- tem 100

//nesten
        vakken.add(new Nest(Kleur.BLAUW, 101, 3, 3));
        vakken.add(new Nest(Kleur.BLAUW, 102, 3, 4));
        vakken.add(new Nest(Kleur.BLAUW, 103, 4, 3));
        vakken.add(new Nest(Kleur.BLAUW, 104, 4, 4));
        vakken.add(new Nest(Kleur.ROOD, 105, 16, 3));
        vakken.add(new Nest(Kleur.ROOD, 106, 16, 4));
        vakken.add(new Nest(Kleur.ROOD, 107, 17, 3));
        vakken.add(new Nest(Kleur.ROOD, 108, 17, 4));
        vakken.add(new Nest(Kleur.GROEN, 109, 16, 16));
        vakken.add(new Nest(Kleur.GROEN, 110, 16, 17));
        vakken.add(new Nest(Kleur.GROEN, 111, 17, 16));
        vakken.add(new Nest(Kleur.GROEN, 112, 17, 17));
        vakken.add(new Nest(Kleur.GEEL, 113, 3, 16));
        vakken.add(new Nest(Kleur.GEEL, 114, 3, 17));
        vakken.add(new Nest(Kleur.GEEL, 115, 4, 16));
        vakken.add(new Nest(Kleur.GEEL, 116, 4, 17));
