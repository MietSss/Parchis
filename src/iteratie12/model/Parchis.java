...
public class Parchis {
    ...
    private int worp;
    private List<Pion> mogelijkeZetten;
    ...
    public boolean isBarriere(int vakNummer) {
        ...
        if (vak.isSafePoint()) {
            ...
            if (pionnenOpVak.size() == 2) {
                //deze pionnen moeten van dezelfde kleur zijn
                Pion eerstePion = pionnenOpVak.get(0);
                Pion tweedePion = pionnenOpVak.get(1);
                if (eerstePion.getKleur().equals(tweedePion.getKleur())) {
                    return true;
                }
            }
        }
    ...
    public Kleur getKleurBarriere(int vakNummerBarriere) {
        List<Pion> pionnenOpVak = spelers.getPionnenOpVak(vakNummerBarriere);
        if (pionnenOpVak.size() == 2) {
            //deze pionnen moeten van dezelfde kleur zijn
            Pion eerstePion = pionnenOpVak.get(0);
            Pion tweedePion = pionnenOpVak.get(1);
            if (eerstePion.getKleur().equals(tweedePion.getKleur())) {
                return eerstePion.getKleur();
            }
        }
        return null;
    }
    ...
    public void printBord() {
        ...
        for (Speler speler : spelers.getSpelers()) {
            for (Pion pion : speler.getPionnen()) {
                ...
                if (bordMetPion[vakPion.getX()][vakPion.getY()] == "x\t") {
                    bordMetPion[vakPion.getX()][vakPion.getY()] = "xx\t";
                } else if (bordMetPion[vakPion.getX()][vakPion.getY()] == "xx\t") {
                    bordMetPion[vakPion.getX()][vakPion.getY()] = "xxx\t";
                } else if (bordMetPion[vakPion.getX()][vakPion.getY()] == "xxx\t") {
