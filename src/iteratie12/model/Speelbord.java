...
public class Speelbord {
    ...
    private List<Integer> padRood;
    private List<Integer> padGeel;
    private List<Integer> padBlauw;
    private List<Integer> padGroen;
                ...
                if (i == 0 || i == AANTAL_RIJEN - 1) {
                    ...
                    for (Vak vak : vakken) {
                        if (vak.getX() == i && vak.getY() == j) {
                            bordZonderPion[i][j] = String.valueOf(vak.getVakNummer()) + "\t";
                            break;
                        } else {
                            bordZonderPion[i][j] = " \t";
                        }
