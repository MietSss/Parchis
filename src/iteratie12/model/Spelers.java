...
public class Spelers {
    ...
    final int MAX_SPELERS = 4;
    private final List<Speler> spelers;
    private Speler spelerAanZet;
    private static Kleur[] kleuren = {Kleur.ROOD, Kleur.BLAUW, Kleur.GEEL, Kleur.GROEN};
    private int aantalSpelers;
    private Speelbord speelbord;
    private List<Pion> allePionnen;
    ...
    public List<Pion> getAllePionnen() {
        return allePionnen;
    }
